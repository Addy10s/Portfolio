<script lang="ts">
	...
	const colors = ['#e81416','#ffa500','#faeb36','#79c314', '#487de7','#4b369d', '#70369d','#e81416','#ffa500','#faeb36','#79c314', '#487de7','#4b369d', '#70369d','#e81416','#ffa500','#faeb36','#79c314', '#487de7','#4b369d', '#70369d','#e81416','#ffa500','#faeb36','#79c314', '#487de7','#4b369d', '#70369d'];
